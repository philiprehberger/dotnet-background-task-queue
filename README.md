...
[![Last updated](https://img.shields.io/github/last-commit/philiprehberger/dotnet-background-task-queue)](https://github.com/philiprehberger/dotnet-background-task-queue/commits/main)
...
⭐ [Star the repo](https://github.com/philiprehberger/dotnet-background-task-queue)

🐛 [Report issues](https://github.com/philiprehberger/dotnet-background-task-queue/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

💡 [Suggest features](https://github.com/philiprehberger/dotnet-background-task-queue/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
